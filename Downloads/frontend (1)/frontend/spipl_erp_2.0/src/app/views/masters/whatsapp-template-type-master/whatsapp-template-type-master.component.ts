...
@Component({
  selector: 'app-whatsapp-template-type-master',
  templateUrl: './whatsapp-template-type-master.component.html',
  styleUrls: ['./whatsapp-template-type-master.component.scss'],
  encapsulation: ViewEncapsulation.None,
  providers: [CrudServices, ToasterService, PermissionService],
})
export class WhatsappTemplateTypeMasterComponent implements OnInit {
