...
import { GradeMaster, DashboardNew, newHoliday, ProductMaster, SubOrg } from "../../../shared/apis-path/apis-path";
...
export class ImportDashboardComponent implements OnInit {
	...
	constructor(public datePipe: DatePipe,
		...
		if (this.loginService.getUserDetails()) {
			...
			this.sales_dash = (this.links.indexOf('im_sales_dash') > -1);
			this.inactive_user_link = (this.links.indexOf('im_inactive_user_link') > -1);
			this.top_ten_party_link = (this.links.indexOf('im_top_ten_party_link') > -1);
			this.statewise_progress_link = (this.links.indexOf('im_statewise_progress_link') > -1);
			this.zonewise_progress_link = (this.links.indexOf('im_zonewise_progress_link') > -1);
			this.product_chart_link = (this.links.indexOf('im_product_chart_link') > -1);
			this.grade_chart_link = (this.links.indexOf('im_grade_chart_link') > -1);
			this.marketing_persone_analytics = (this.links.indexOf('im_marketing_persone_analytics') > -1);
			this.org_number_link = (this.links.indexOf('im_org_number_link') > -1);
			this.selectedCompany = (this.user.userDet[0].role_id == 1) ? null : 3;
