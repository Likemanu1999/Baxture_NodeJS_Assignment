...
@Component({
  selector: 'app-redis-detail-inventory',
  templateUrl: './redis-detail-inventory.component.html',
  styleUrls: ['./redis-detail-inventory.component.scss'],
  providers: [CrudServices, DatePipe, ToasterService, ExportService]
})
export class RedisDetailInventoryComponent implements OnInit {
