...
@Component({
	selector: 'app-detail-inventory-import-local',
	templateUrl: './detail-inventory-import-local.component.html',
	styleUrls: ['./detail-inventory-import-local.component.scss'],
	encapsulation: ViewEncapsulation.None,
	providers: [CrudServices, DatePipe, ToasterService, ExportService, LoginService]
})
export class DetailInventoryImportLocalComponent implements OnInit {
