...
@Component({
	...
	providers: [CrudServices, ToasterService, PermissionService, DatePipe, ExportService]
})
export class ImportCollectionComponent implements OnInit {
	...
	getCols() {
		this.cols = [
			...
			// { field: "import_local_flag_cat", header: "Category", sort: true, filter: false, dropdown: [], footer: false, total: 0, type: 'Badge' },
		...
		this.filter = ['customer', 'virtual_acc_no', 'utr_no', 'company_name', 'payment_type', 'is_transfered_label', 'remark'];
	}
