...
@Component({
	selector: 'app-my-job-references',
	templateUrl: './my-job-references.component.html',
	styleUrls: ['./my-job-references.component.scss'],
	encapsulation: ViewEncapsulation.None,
	providers: [CrudServices, ToasterService, PermissionService, ExportService]
})

export class MyJobReferencesComponent implements OnInit {
