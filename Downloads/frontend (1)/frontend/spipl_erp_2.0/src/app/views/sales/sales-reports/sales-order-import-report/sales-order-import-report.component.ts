...
@Component({
  selector: 'app-sales-order-import-report',
  templateUrl: './sales-order-import-report.component.html',
  styleUrls: ['./sales-order-import-report.component.scss'],
  providers: [PermissionService, CrudServices, ExportService, LoginService]
})
export class SalesOrderImportReportComponent implements OnInit {
