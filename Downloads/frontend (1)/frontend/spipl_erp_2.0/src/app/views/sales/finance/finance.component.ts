...
export class FinanceComponent implements OnInit {
	...
	page_title: any = "Finance Planning List"
	...
	statusList: any = staticValues.finance_p_status;
	...
	getData() {
		...
		this.crudServices.getOne<any>(DispatchNew.getPendingDispatchesFinance, condition).subscribe(res => {
	...
	getCols() {
		...
		this.filter = ['customer', 'city', 'godown_name', 'grade_name', 'delivery_term', 'zone'];
		this.getData();
	}
	...
	// 			id: selected_company_data.id,
	// 			name: selected_company_data.name
	// 		};
	// 		this.getCols();
	// 	}
	// }
