...
@Component({
  selector: 'app-total-lc-open-report',
  templateUrl: './total-lc-open-report.component.html',
  styleUrls: ['./total-lc-open-report.component.scss'],
  providers: [
    ExportService,
    ToasterService,
    CrudServices
...
export class TotalLcOpenReportComponent implements OnInit {
