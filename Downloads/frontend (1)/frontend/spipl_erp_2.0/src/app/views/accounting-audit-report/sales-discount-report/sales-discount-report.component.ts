...
@Component({
	selector: 'app-sales-discount-report',
	templateUrl: './sales-discount-report.component.html',
	styleUrls: ['./sales-discount-report.component.scss'],
	encapsulation: ViewEncapsulation.None,
	providers: [CrudServices, ToasterService, PermissionService, ExportService]
})

export class SalesDiscountReportComponent implements OnInit {
	...
	page_title: any = "Sales Discount Report";
	...
	getCols() {
		this.cols = [
			...
			{ field: "party_state", header: "Party Type", sort: true, filter: true, dropdown: [], footer: false, total: 0, type: null },
